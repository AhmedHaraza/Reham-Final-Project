...
import 'package:online_school_admission/parent/page10_home/featur/view/home_page_view.dart';
import 'package:online_school_admission/parent/your_profile.dart';
import '../Payment.dart';
import '../features/page47_payment_method/featur/view/page47_payment_method_view.dart';
import 'payment.dart';
        ...
        leading: IconButton(
          onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => const HomeView(), // Navigate back to SignIn widget
              ),
            );
          },
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) =>  const Page47PaymentMethodView(), // Navigate back to SignIn widget
                    ),
                  );
