...
class SchoolProfile extends StatelessWidget {
  const SchoolProfile({Key? key}) : super(key: key);
        ...
        leading: IconButton(
          onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => const HomeView2(), // Navigate back to SignIn widget
              ),
            );
          },
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => ApplicationSubmitPageOneView()),
                  );
                },
